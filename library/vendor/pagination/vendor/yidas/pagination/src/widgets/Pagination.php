...
class Pagination
{
    ...
    public function run()
    {
        ...
        if($isFirst) {
            $output .= '<li class="page-item disabled"><span class="page-link"><span data-feather="chevrons-left"></span></span></li>';
        } else {
            $output .= '<li class="page-item"><a href="'.$this->pagination->createUrl(1).'" class="page-link" data-popup="tooltip" title="Prima pagină"><span data-feather="chevrons-left"></span></a></li>';
            $output .= '<li class="page-item"><a href="'.$this->pagination->createUrl($page - 1).'" class="page-link" data-popup="tooltip" title="Pagina anterioară"><span data-feather="chevron-left"></span></a></li>';
        }

        $view_content = file_get_contents($viewFile);
        ...
        foreach($this->_buttonStack as $key=>$btnPage) {
            $is_active = $page == $btnPage ? 'active' : '';

            $rpl = [
                $is_active,
                $this->pagination->createUrl($btnPage),
                $btnPage
            ];

            $output .= str_replace($src, $rpl, $view_content);
        }

        if($isLast) {
            $output .= '<li class="page-item disabled"><span class="page-link"><span data-feather="chevrons-right"></span></span></li>';
        } else {
            $output .= '<li class="page-item"><a href="'.$this->pagination->createUrl($page + 1).'" class="page-link" data-popup="tooltip" title="Pagina următoare"><span data-feather="chevron-right"></span></a></li>';
            $output .= '<li class="page-item"><a href="'.$this->pagination->createUrl($this->pagination->pageCount).'" class="page-link" data-popup="tooltip" title="Ultima pagină"><span data-feather="chevrons-right"></span></a></li>';
        }
